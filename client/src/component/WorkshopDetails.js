...
export default function WorkshopDetails() {
  ...
  const handleEnroll = async () => {
    ...
    try {
      ...
      navigate("/my-enrollments"); // navigate to MyEnrollments page
    } catch (err) {
      console.error("Enrollment error:", err.response || err.message || err);
      alert(
    ...
    <div className="course-container">
      ...
      <div className="course-card" style={{ margin: "0 auto", maxWidth: "500px" }}>
        ...
        <div className="course-buttons" style={{ justifyContent: "center", marginTop: "15px" }}>
          <button className="edit-btn" onClick={handleEnroll}>
            Enroll Now
          </button>
